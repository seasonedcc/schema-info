---
name: release
description: Release a new version of the schema-info npm package. Bump version, build, publish, and create a GitHub release. Use when the user mentions releasing, publishing, cutting a release, or shipping a new version.
metadata:
  internal: true
---
...
Automate the release workflow for the `schema-info` npm package.
...
```
* <title> by @<author> in https://github.com/seasonedcc/schema-info/pull/<number>
```

End with:

```
**Full Changelog**: https://github.com/seasonedcc/schema-info/compare/v<previous>...v<new>
```
